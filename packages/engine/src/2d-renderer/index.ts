...
import { ShadowRenderer } from "./webgl/renderer/ShadowRenderer";
...
export * from "./renderData/ShadowRenderData";
...
export const renderManagerFactory = (canvas: HTMLCanvasElement): IRenderManager => {
    ...
    const webglManager = new WebGLManager(
        ...
        new Map<RenderDataType, IRenderer>([
            ...
            [RenderDataType.Shadow, new ShadowRenderer(gl, programManager)],
        ]),
    );
