[angry-pixel](../README.md) / [Exports](../modules.md) / BoxCollider
...
- [allowMultiple](BoxCollider.md#allowmultiple)
- [assetManager](BoxCollider.md#assetmanager)
- [colliders](BoxCollider.md#colliders)
- [debug](BoxCollider.md#debug)
- [domManager](BoxCollider.md#dommanager)
- [gameConfig](BoxCollider.md#gameconfig)
- [gameObject](BoxCollider.md#gameobject)
- [gameObjectManager](BoxCollider.md#gameobjectmanager)
- [height](BoxCollider.md#height)
- [inputManager](BoxCollider.md#inputmanager)
- [layer](BoxCollider.md#layer)
- [name](BoxCollider.md#name)
- [offsetX](BoxCollider.md#offsetx)
- [offsetY](BoxCollider.md#offsety)
- [physics](BoxCollider.md#physics)
- [physicsManager](BoxCollider.md#physicsmanager)
- [renderManager](BoxCollider.md#rendermanager)
- [renderer](BoxCollider.md#renderer)
- [rotation](BoxCollider.md#rotation)
- [sceneManager](BoxCollider.md#scenemanager)
- [timeManager](BoxCollider.md#timemanager)
- [updateEvent](BoxCollider.md#updateevent)
- [width](BoxCollider.md#width)

### Accessors

- [active](BoxCollider.md#active)

### Methods

- [addGameObject](BoxCollider.md#addgameobject)
- [collidesWithLayer](BoxCollider.md#collideswithlayer)
- [destroyGameObject](BoxCollider.md#destroygameobject)
- [findGameObject](BoxCollider.md#findgameobject)
- [findGameObjects](BoxCollider.md#findgameobjects)
- [findGameObjectsByTag](BoxCollider.md#findgameobjectsbytag)
- [getCollisionWithLayer](BoxCollider.md#getcollisionwithlayer)
- [getCollisionsWithLayer](BoxCollider.md#getcollisionswithlayer)
- [getComponent](BoxCollider.md#getcomponent)
- [getComponents](BoxCollider.md#getcomponents)
- [getCurrentScene](BoxCollider.md#getcurrentscene)
- [getGameObject](BoxCollider.md#getgameobject)
- [hasComponent](BoxCollider.md#hascomponent)
- [init](BoxCollider.md#init)
- [onActiveChange](BoxCollider.md#onactivechange)
- [onDestroy](BoxCollider.md#ondestroy)
- [removeComponent](BoxCollider.md#removecomponent)
- [start](BoxCollider.md#start)
- [update](BoxCollider.md#update)
- [updateColliders](BoxCollider.md#updatecolliders)
- [updatePosition](BoxCollider.md#updateposition)
- [updateRealSize](BoxCollider.md#updaterealsize)
...
[src/component/collider/BoxCollider.ts:56](https://github.com/angry-pixel-studio/angry-pixel-engine/blob/8704b49/src/component/collider/BoxCollider.ts#L56)
...
[src/component/collider/BoxCollider.ts:60](https://github.com/angry-pixel-studio/angry-pixel-engine/blob/8704b49/src/component/collider/BoxCollider.ts#L60)
...
[src/component/collider/BoxCollider.ts:62](https://github.com/angry-pixel-studio/angry-pixel-engine/blob/8704b49/src/component/collider/BoxCollider.ts#L62)
...
[src/component/collider/BoxCollider.ts:64](https://github.com/angry-pixel-studio/angry-pixel-engine/blob/8704b49/src/component/collider/BoxCollider.ts#L64)
...
[src/component/collider/BoxCollider.ts:66](https://github.com/angry-pixel-studio/angry-pixel-engine/blob/8704b49/src/component/collider/BoxCollider.ts#L66)
...
[src/component/collider/BoxCollider.ts:58](https://github.com/angry-pixel-studio/angry-pixel-engine/blob/8704b49/src/component/collider/BoxCollider.ts#L58)
...
[src/component/collider/Collider.ts:79](https://github.com/angry-pixel-studio/angry-pixel-engine/blob/8704b49/src/component/collider/Collider.ts#L79)
...
| Name | Type |
| :------ | :------ |
| `config` | [`BoxColliderOptions`](../interfaces/BoxColliderOptions.md) |
...
[src/component/collider/BoxCollider.ts:77](https://github.com/angry-pixel-studio/angry-pixel-engine/blob/8704b49/src/component/collider/BoxCollider.ts#L77)
...
[src/component/collider/Collider.ts:132](https://github.com/angry-pixel-studio/angry-pixel-engine/blob/8704b49/src/component/collider/Collider.ts#L132)
...
[src/component/collider/BoxCollider.ts:133](https://github.com/angry-pixel-studio/angry-pixel-engine/blob/8704b49/src/component/collider/BoxCollider.ts#L133)
...
[src/component/collider/BoxCollider.ts:114](https://github.com/angry-pixel-studio/angry-pixel-engine/blob/8704b49/src/component/collider/BoxCollider.ts#L114)
...
[src/component/collider/BoxCollider.ts:104](https://github.com/angry-pixel-studio/angry-pixel-engine/blob/8704b49/src/component/collider/BoxCollider.ts#L104)
