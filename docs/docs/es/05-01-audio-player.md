...
| `audioSource`              | `AudioSource` \| `string` | Fuente de audio que se reproducirá (obtenida de `AssetManager.getAudio`, o un string con la URL/nombre).         |
...
| Método                                      | Descripción                                                                                                      |
| ------------------------------------------- | ---------------------------------------------------------------------------------------------------------------- |
| `play(audioSource?: AudioSource \| string)` | Establece la acción `play` para iniciar la reproducción. Si se pasa un nuevo `audioSource`, se usará esa fuente. |
...
-   El `AudioPlayer` acepta una `AudioSource` (obtenida de `AssetManager.getAudio`) o un string con la URL/nombre del asset.
-   La reproducción usa la Web Audio API.
