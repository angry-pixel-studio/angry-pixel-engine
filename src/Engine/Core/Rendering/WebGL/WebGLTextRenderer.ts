...
export class WebGLImageRenderer {
    ...
    public renderCanvas(
        ...
        this.textTex = this.textureFactory.createFromCanvas(canvas, smooth, this.textTex);
        ...
        this.textureMatrix = mat4.identity(this.textureMatrix);
        mat4.scale(this.textureMatrix, this.textureMatrix, [width / canvas.width, height / canvas.height, 1]);
        mat4.scale(this.textureMatrix, this.textureMatrix, [2, 2, 1]);
