...
var GameObjectManager = /** @class */ (function () {
    ...
    GameObjectManager.prototype.destroyAllGameObjects = function () {
        var _this = this;
        this.gameObjects.every(function (gameObject) { return _this._destroyGameObject(gameObject, false); });
        this.gameObjects = [];
    };
    ...
    GameObjectManager.prototype.destroyChildren = function (parent) {
        var _this = this;
        this.findGameObjectsByParent(parent).every(function (gameObject) {
