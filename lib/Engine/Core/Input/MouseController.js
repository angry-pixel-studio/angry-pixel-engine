...
var MouseController = /** @class */ (function () {
    ...
    MouseController.prototype.setup = function () {
        var _this = this;
        var canvas = this.gameNode.querySelector("canvas");
        canvas.addEventListener("mousemove", function (e) { return _this.updatePosition(e); });
        canvas.addEventListener("mousedown", function (e) { return _this.updateButtonDown(e); });
        canvas.addEventListener("mouseup", function (e) { return _this.updateButtonUp(e); });
