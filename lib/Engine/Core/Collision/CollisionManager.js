...
var SatResolver_1 = require("./Sat/SatResolver");
var CollisionManager = /** @class */ (function () {
    function CollisionManager(renderManager) {
        this.debug = false;
        this.colliders = [];
        this.satResolver = new SatResolver_1.SatResolver();
    ...
    CollisionManager.prototype.narrowPhase = function (collider, colliders) {
        ...
        for (var _i = 0, colliders_1 = colliders; _i < colliders_1.length; _i++) {
            var remoteCollider = colliders_1[_i];
            var satData = this.satResolver.getSatData(collider.shape, remoteCollider.shape);
            if (satData !== null) {
                collisions.push({
