...
var Context2DRenderer = /** @class */ (function () {
    ...
    Context2DRenderer.prototype.updateRenderPosition = function (renderData) {
        ...
        renderData.viewportPosition.x = Number((renderData.viewportPosition.x + this.canvas.clientWidth / 2).toFixed(0));
        renderData.viewportPosition.y = Number((this.canvas.clientHeight / 2 - renderData.viewportPosition.y).toFixed(0));
    };
