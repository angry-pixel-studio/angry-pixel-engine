...
exports.WebGLImageRenderer = void 0;
...
var WebGLImageRenderer = /** @class */ (function () {
    function WebGLImageRenderer(canvas, programFactory, textureFactory) {
    ...
    WebGLImageRenderer.prototype.renderImage = function (viewportRect, image, position, width, height, slice, rotation, flipHorizontal, flipVertical, alpha, smooth) {
        ...
        var textureHash = sha256(image.src).toString();
        ...
        this.textureMatrix = gl_matrix_1.mat4.identity(this.textureMatrix);
        if (slice !== null) {
        ...
        this.projectionMatrix = gl_matrix_1.mat4.identity(this.projectionMatrix);
        gl_matrix_1.mat4.ortho(this.projectionMatrix, viewportRect.x, viewportRect.x1, viewportRect.y, viewportRect.y1, -1, 1);
    ...
    return WebGLImageRenderer;
}());
exports.WebGLImageRenderer = WebGLImageRenderer;
//# sourceMappingURL=WebGLImageRenderer.js.map