...
var RenderManager = /** @class */ (function () {
    ...
    RenderManager.prototype.setViewportPosition = function (renderData) {
        if (renderData.ui !== true) {
            renderData.viewportPosition.set(Number((renderData.position.x - this._worldSpaceViewRect.x - this._worldSpaceViewRect.width / 2).toFixed(0)), Number((renderData.position.y - this._worldSpaceViewRect.y + this._worldSpaceViewRect.height / 2).toFixed(0)));
        }
        else {
