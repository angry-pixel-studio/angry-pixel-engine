...
var Component = /** @class */ (function () {
    function Component() {
        ...
        this.gameLoopEventHandler = function (event) {
            ...
            else if (_this.started === true && event.type === _this.updateEvent) {
                _this.update();
            }
        };
    ...
    Object.defineProperty(Component.prototype, "updateEvent", {
        get: function () {
            return Game_1.EVENT_UPDATE;
        },
        enumerable: false,
        configurable: true
    });
...
var PhysicsComponent = /** @class */ (function (_super) {
    ...
    Object.defineProperty(PhysicsComponent.prototype, "updateEvent", {
        get: function () {
            return Game_1.EVENT_UPDATE_PHYSICS;
        },
        enumerable: false,
        configurable: true
    });
...
var RenderComponent = /** @class */ (function (_super) {
    ...
    Object.defineProperty(RenderComponent.prototype, "updateEvent", {
        get: function () {
            return Game_1.EVENT_UPDATE_RENDER;
        },
        enumerable: false,
        configurable: true
    });
