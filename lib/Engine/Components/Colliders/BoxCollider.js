...
var BoxCollider = /** @class */ (function (_super) {
    ...
    BoxCollider.prototype.start = function () {
        var _this = this;
        this.updateRealSize();
        this.addCollider(new RectangleCollider_1.RectangleCollider(this.gameObject.transform.position, this.realWidth, this.realHeight, this.gameObject));
        if (this.debug) {
...
var TYPE_BOX_COLLIDER_RENDERER = "BoxCollider";
