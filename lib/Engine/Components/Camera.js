...
var Camera = /** @class */ (function (_super) {
    ...
    Camera.prototype.setupViewportRect = function () {
        this._viewportRect.setPosition(-(Game_1.gameCanvas.clientWidth / 2), Game_1.gameCanvas.clientHeight / 2);
        this._viewportRect.width = Game_1.gameCanvas.clientWidth;
        this._viewportRect.height = Game_1.gameCanvas.clientHeight;
