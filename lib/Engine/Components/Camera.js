...
var Camera = /** @class */ (function (_super) {
    ...
    function Camera() {
        ...
        _this.canvasWidth = _this.domManager.gameCanvas.width;
        _this.canvasHeight = _this.domManager.gameCanvas.height;
        _this.canvasHalfWidth = _this.canvasWidth / 2;
        _this.canvasHalfHeight = _this.canvasHeight / 2;
        return _this;
    }
