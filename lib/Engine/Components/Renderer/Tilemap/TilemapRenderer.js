...
var TilemapRenderer = /** @class */ (function (_super) {
    ...
    TilemapRenderer.prototype.createRenderData = function (tile, col, row, alpha, flip) {
        ...
        renderData.position.set(this.gameObject.transform.position.x + col * this.tileWidth + this.tileWidth / 2, this.gameObject.transform.position.y - row * this.tileHeight - this.tileHeight / 2);
        renderData.ui = false;
    ...
    TilemapRenderer.prototype.updateTilesPosition = function () {
        ...
        this.tilesRenderData.forEach(function (renderData) {
            renderData.position.set(renderData.position.x - Math.floor(_this._realWidth / 2), renderData.position.y + Math.floor(_this._realHeight / 2));
