...
var AbstractTilemapRenderer = /** @class */ (function (_super) {
    ...
    AbstractTilemapRenderer.prototype.processTile = function (tile, col, row, alpha) {
        if (alpha === void 0) { alpha = 1; }
        var renderData = this.createRenderData(tile, col, row, alpha);
        this.updateSizeInfo(col + 1, row + 1);
        this.tilesRenderData.push(renderData);
    };
    AbstractTilemapRenderer.prototype.createRenderData = function (tile, col, row, alpha) {
        if (alpha === void 0) { alpha = 1; }
