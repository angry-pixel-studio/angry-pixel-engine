...
var SpriteRenderer = /** @class */ (function (_super) {
    ...
    SpriteRenderer.prototype.calculateRenderPosition = function () {
        this.renderData.position.set(this.gameObject.transform.position.x + this.offsetX, this.gameObject.transform.position.y + this.offsetY);
    ...
    SpriteRenderer.prototype.translateRenderPosition = function () {
        ...
        this.renderData.position.set(this.goPosition.x + radius * Math.cos(angle), this.goPosition.y - radius * Math.sin(angle));
    };
